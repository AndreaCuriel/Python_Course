...
#instancia de clase Moto (objeto)
...
#Crear instancia de la Furgoneta

miFurgoneta=Furgoneta("Renault", "Kamgoo")
miFurgoneta.arranca()
miFurgoneta.estado()
...
#Crear una instancia de BicicletaElectrica que hereda de dos clases

miBiciE=BicicletaElectrica("Bennotto", "Wildcat") #utiliza el contructor de la clase VElectricos
miBiciE.estado()
